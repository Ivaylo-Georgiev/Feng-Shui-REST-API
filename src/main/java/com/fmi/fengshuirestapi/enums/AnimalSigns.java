...
public enum AnimalSign {
	...
	RAT(4, 23, "OX", "DRAGON,MONKEY", "HORSE", "ROOSTER"), OX(5, 1, "RAT", "SNAKE,ROOSTER", "SHEEP", "HORSE"), TIGER(6,
			3, "PIG", "HORSE,DOG", "MONKEY",
			"RABBIT"), RABBIT(7, 5, "DOG", "SHEEP,PIG", "ROOSTER", "RAT"), DRAGON(8, 7, "ROOSTER", "MONKEY,RAT", "DOG",
					"ROOSTER"), SNAKE(9, 9, "MONKEY", "OX,ROOSTER", "PIG", "HORSE"), HORSE(10, 11, "SHEEP", "TIGER,DOG",
							"RAT", "RABBIT"), SHEEP(11, 13, "HORSE", "RABBIT,PIG", "OX", "RAT"), MONKEY(0, 15, "SNAKE",
									"DRAGON,RAT", "TIGER", "ROOSTER"), ROOSTER(1, 17, "DRAGON", "OX,SNAKE", "RABBIT",
											"HORSE"), DOG(2, 19, "RABBIT", "TIGER,HORSE", "DRAGON",
													"RABBIT"), PIG(3, 21, "TIGER", "RABBIT,SHEEP", "SNAKE", "RAT");
	...
	public String getPeachBlossomAnimal() {
		return this.peachBlossomAnimal;
	}
